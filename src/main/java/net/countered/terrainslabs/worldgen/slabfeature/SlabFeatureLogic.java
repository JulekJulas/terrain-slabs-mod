...
public class SlabFeatureLogic extends Feature<DefaultFeatureConfig> {
    ...
    static {
        ...
        //terralith
        VALID_BLOCKS_FOR_SLAB_PLACEMENT.add(Blocks.CALCITE);
        VALID_BLOCKS_FOR_SLAB_PLACEMENT.add(Blocks.SMOOTH_BASALT);
        VALID_BLOCKS_FOR_SLAB_PLACEMENT.add(Blocks.LIGHT_BLUE_TERRACOTTA);
        VALID_BLOCKS_FOR_SLAB_PLACEMENT.add(Blocks.CYAN_TERRACOTTA);
        VALID_BLOCKS_FOR_SLAB_PLACEMENT.add(Blocks.COBBLESTONE);
        VALID_BLOCKS_FOR_SLAB_PLACEMENT.add(Blocks.MOSSY_COBBLESTONE);
        VALID_BLOCKS_FOR_SLAB_PLACEMENT.add(Blocks.COBBLED_DEEPSLATE);
